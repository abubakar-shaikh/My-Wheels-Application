...
const SignUp = ({navigation}) => {
  ...
  const signUp = () => {
    ...
    } else if (view == 'email' && !Required('password', password))
      setPasswordErr(true);
    ...
    } else if (view == 'phone' && !Required('Mobile Number', mobileNumber))
    ...
    <Container asGradient>
      ...
      <View style={styles.innerContainer}>
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <>
            <ButtonGroup
              buttons={['Signup With Email', 'Signup With Phone']}
              selectedIndex={view === 'email' ? 0 : 1}
              onPress={value => {
                value ? setView('phone') : setView('email');
              }}
